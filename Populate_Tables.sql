...
-- Roles
INSERT INTO restaurant.role (name, description) VALUES
...
-- Employees
INSERT INTO restaurant.employee (role_id, first_name, last_name, email, phone, hire_date, active) VALUES
...
-- Customers
INSERT INTO restaurant.customer (first_name, last_name, email, phone, created_at) VALUES
...
-- Addresses
INSERT INTO restaurant.address (customer_id, street, city, postal_code, notes, is_default) VALUES
...
-- Categories
INSERT INTO restaurant.category (name, description) VALUES
...
-- Menu Items
INSERT INTO restaurant.menu (category_id, name, description, price, is_available) VALUES
...
-- Inventory Items
INSERT INTO restaurant.inventory (name, unit, current_quantity, reorder_level) VALUES
('Tomatoes', 'kg', 45.5, 20),
('Garlic', 'bulbs', 120, 50),
...
INSERT INTO restaurant.menu_item_ingredient (menu_item_id, inventory_item_id, quantity_per_unit) VALUES
...
-- Orders
INSERT INTO restaurant.orders (customer_id, cashier_id, delivery_address_id, order_datetime, status, payment_method, payment_status, total_amount) VALUES
(1, 2, 1, '2024-11-20 18:30:00', 'DELIVERED', 'CARD', 'PAID', 53.97),
(2, 2, 3, '2024-11-21 19:00:00', 'DELIVERED', 'CASH', 'PAID', 49.96),
(3, 6, 4, '2024-11-22 12:15:00', 'DELIVERED', 'ONLINE', 'PAID', 47.97),
(4, 2, 5, '2024-11-23 17:45:00', 'OUT_FOR_DELIVERY', 'CARD', 'PAID', 54.96),
(5, 6, 6, '2024-11-24 18:00:00', 'PREPARING', 'ONLINE', 'UNPAID', 39.97),
(1, 2, 1, '2024-11-25 19:30:00', 'PENDING', 'CARD', 'UNPAID', 32.98);
...
-- Delivery Records
INSERT INTO restaurant.delivery (order_id, driver_id, assigned_time, pickup_time, delivery_time, delivery_status) VALUES
...
INSERT INTO restaurant.order_status_history (order_id, old_status, new_status, changed_by_employee_id, changed_at) VALUES
